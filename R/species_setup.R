...
############################ copy shell Scripts
    file.copy(paste0(system.file(package="testInvPath","skeletons"),"/runSimulation.sh"),paste0(newdir,"/src/simulation.slurm"))
    Sys.chmod(paste0(newdir,"/src/simulation.slurm"),mode="755")
################### create some files
